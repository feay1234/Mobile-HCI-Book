 ...
 */
public class spare extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSensorListener.setOnShakeListener(new ShakeEventListener.OnShakeListener() {
          ...
          public void onShake() {
            Toast.makeText(spare.this, "Shake!", Toast.LENGTH_SHORT).show();
...
//        pauseSomeStuff();
    ...
    public static class SmartFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            // create map
            final GoogleMap mMap = ((SupportMapFragment) getFragmentManager().findFragmentById(R.id.map)).getMap();
            ...
            LocationResult locationResult = new LocationResult() {
    			...
    			public void gotLocation(Location location) {
    				...
    				MyMap myMap = new MyMap(getActivity(),mMap, myWebView, location, "");
    	            myMap.initial();
    				
    				for(int i=0;i<locationBook.length;i+=2){
    					if(distance(locationBook[i],locationBook[i+1], location.getLatitude(), location.getLongitude(), 'K') < 0.1){
    						near_location = location_name[i];
